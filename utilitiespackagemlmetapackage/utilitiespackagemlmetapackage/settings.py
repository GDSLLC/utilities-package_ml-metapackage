from utilitiespackagemlmetapackage.derived_settings import APPDIR, SETUPFILEDIR, TESTDIR, MEMTEMPDIR
...
def set_vars():
    ...
    PROJECT_NAME = "utilitiespackagemlmetapackage"
    TEMPDIR = "/tmp"
    TEXTTABLE_STYLE = ["-", "|", "+", "-"]
    DIRS = [f"{TEMPDIR}/utilitiespackagemlmetapackage"]
